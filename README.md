...
- [ ] Explain what a token is used for.
    ...
    A. A token is used to authenticate a user and flag them as having appropriate access to protected data

- [ ] What steps can you take in your web apps to keep your data secure?

    A. Protected routes that require a tokin are a common way to keep data secure.

- [ ] Describe how web servers work.

    A. Web servers host data online and allow access to "CRUD" the data with specified endpoints.
